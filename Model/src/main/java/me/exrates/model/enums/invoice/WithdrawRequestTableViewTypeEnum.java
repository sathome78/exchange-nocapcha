...
public enum WithdrawRequestTableViewTypeEnum {
    ...
    ALL,
    FOR_WORK(WAITING_MANUAL_POSTING, IN_WORK_OF_ADMIN, WAITING_CONFIRMATION, TAKEN_FOR_WITHDRAW),
    FOR_MANUAL(WAITING_MANUAL_POSTING, IN_WORK_OF_ADMIN, WAITING_CONFIRMATION, TAKEN_FOR_WITHDRAW),
    ...
    FOR_CHECKING(WAITING_REVIEWING);
