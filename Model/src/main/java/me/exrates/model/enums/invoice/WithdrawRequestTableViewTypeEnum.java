...
public enum WithdrawRequestTableViewTypeEnum {
  ...
  ALL,
  FOR_WORK(WAITING_MANUAL_POSTING, IN_WORK_OF_ADMIN, WAITING_CONFIRMATION, WAITING_REVIEWING),
  FOR_MANUAL(WAITING_MANUAL_POSTING, IN_WORK_OF_ADMIN, TAKEN_FOR_WITHDRAW),
