jQuery(document).ready(function($) {
    ...
    $('#nickname').on("change click focus hover keydown keypress", debounce(function(){
        var username = $(this);
    ...
    $('#nickname_change_form').submit(function(e) {
        $.ajax('/settings/changeNickname/submit', {
            headers: {
                'X-CSRF-Token': $("input[name='_csrf']").val()
            },
            type: 'POST',
            data: $("#user-settings-nickname-form").serialize()
        })
    });
