jQuery(document).ready(function($) {
    ...
    $('#email_pwd_restore').on("change keyup blur input", debounce(function () {
    ...
    $('#nickname').on("change keyup blur input", debounce(function(){
        var username = $(this);
    ...
    $('#password').on("change keyup blur input", debounce(function(){
