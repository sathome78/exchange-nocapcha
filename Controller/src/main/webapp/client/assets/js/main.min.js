...
jQuery(document).ready(function($) {
    ...
    $('#email').on("change keyup", debounce(function(){
        ...
        var ipBannedErrorText = ipBannedErrorField.text();
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                console.log("*** ipBannedErrorText ***"+ipBannedErrorText);
                ...
                if (result === "emailExists") {
                    ...
                    $("#reg_submit").prop('disabled', true);
                    return;
                } else if(result === ipBannedErrorText){
                    email.addClass('field__input--error').siblings('.field__label').addClass('field__label--error');
    ...
    $('#email_pwd_restore').on("change keyup", function() {
        ...
        var ipBannedErrorTextRecover = ipBannedErrorFieldRecover.text();
        ...
        if (emailPattern.test(email.val())) {
            $.ajax({
                ...
                success: function(result){
                    console.log("*** RESULT ***"+result);
                    console.log("*** ipBannedErrorTextRecover ***"+ipBannedErrorTextRecover);
                    if (result === "emailExists") {
                        ...
                        email.addClass('field__input--error').siblings('.field__label').addClass('field__label--error');
                        $('#ip_banned_incorrect_attempts_exceeded_recover').css('display', 'block');
                        $('#pwd_restore_submit').prop('disabled', true);
                        return;
                    } else {
                        email.addClass('field__input--error').siblings('.field__label').addClass('field__label--error');
