jQuery(document).ready(function($) {
    ...
    $('#create_me').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                form[0].reset();
                $.fancybox.close();
                $('#confirm_email').append(data.user.email);
    ...
    $('#finish_registration').submit(function(e) {
        var form = $(this);
        var url = "/createUser";
    ...
    $('#nickname').keyup(debounce(function(){
        ...
        var pattern = new RegExp('^[a-zA-Z][_A-Za-z0-9\\\\-_]{2,20}$');
    ...
    $('#password').keyup(debounce(function(){
        ...
        var val = pasword.val();
        var pattern = new RegExp("^[a-zA-Z0-9][\\w!#$%&'*+/=?`{|}~^-]{8,20}$");
...
function checkRegForm() {
    ...
    if ((!$('#email')[0] || (email.length != 0) && (nickname.length != 0))) {
