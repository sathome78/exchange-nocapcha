(function () {
    ...
    e.AmStockChart = e.Class({
        construct: function (a) {
            ...
            b = e.changeDate(b, this.categoryAxesSettings.minPeriod, 1, !0).getTime();
            -1 == a.indexOf("fff") && --b;
            return new Date(b)
        ...
        delayedParseStockData: function (a, b) {
                ...
                for (q = 0; q < t; q++) {
                    ...
                    for (z = g; z < m; z++) {
                        ...
                        if (z == g || C >= y[p] || !y[p]) {
                            ...
                            v[p][n] = e.newDate(D, b)
                        } else for (w = v[p], w.rawData && w.rawData.push(B), p = 0; p < E; p++) u = A[p].toField, q == t - 1 && (w[n] = e.newDate(D, b)), null !== r[u] && (x = Number(r[u]), isNaN(x) || (isNaN(w[u + "Low"]) && (w[u + "Low"] = x), x < w[u + "Low"] && (w[u + "Low"] = x), isNaN(w[u + "High"]) && (w[u + "High"] = x), x > w[u + "High"] && (w[u + "High"] = x), isNaN(w[u + "AbsHigh"]) && (w[u + "AbsHigh"] = x), Math.abs(x) > w[u +
            ...
            }, f.processTimeout) : f.parseEvents(a, f.panels, f.stockEventsSettings, f.firstDayOfWeek,
            ...
            for (var y in l) if (l.hasOwnProperty(y)) for (b =
            ...
            for (var a = this.panels, b = 0; b < a.length; b++) {
                var c =
                    a[b], c = e.processObject(c, e.StockPanel, this.theme, !0);
                a[b] = c;
            ...
            if (a) {
                ...
                if (b) {
                    ...
                    if (0 < a.dataProvider.length) {
                        ...
                        b.dataProvider = f ? a.agregatedDataProviders[f] : a.agregatedDataProviders[d]
                    } else b.dataProvider = [];
                    f = b.categoryAxis;
                    f.minPeriod = d;
            ...
            if (k && f) {
                ...
                if (l) {
                    ...
                    a.getTime() ==
                    b.getTime() && v != n && (b = e.changeDate(b, v.period, v.count), b.setTime(b.getTime() - 1))
                }
                ...
                v = e.newDate(a);
                c.extendToFullPeriod && (v.getTime() - k.getTime() < .1 * A && (v = e.resetDateToMin(a, n.period,
                    n.count, y)), f.getTime() - b.getTime() < .1 * A && (b = e.resetDateToMin(f, n.period, n.count, y), b = e.changeDate(b, n.period, n.count, !0)));
                ...
                for (k = 0; k < q.length; k++) {
                    ...
                    if (l != h) {
                        ...
                        if (d = f.chartCursor) d.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat(n.period),
                        f.showCategoryAxis || (d.categoryBalloonEnabled = !1);
            ...
            this.skipEvents || (this.chartCreated || (this.chartCreated = !0, this.fire({
                type: "init",
                chart: this
            })), this.chartRendered || (this.chartRendered =
                !0, this.fire({type: "rendered", chart: this})), this.fire({type: "drawn", chart: this}));
                            ...
                            if (g.valueAxis) {
                                ...
                                for (D = 0; D < B; D++) {
                                    ...
                                    if (m) {
                                        ...
                                        if (h = g.compareGraphNegativeFillAlphas) r.negativeFillAlphas =
                                            h;
            ...
            return (g - n) / h > m && 0 < m && l ?
                this.choosePeriod(a + 1, b, c) : f
    ...
    e.PeriodSelector = e.Class({
        construct: function (a) {
            ...
            if (b.inputFieldsEnabled) {
                ...
                n.appendChild(m);
                b.startDateField = m;
                if (f) g = b.width - 6 + "px", e.addBr(n); else {
            ...
            if (e.ifArray(n)) {
                ...
                for (a = 0; a < n.length; a++) c = n[a], t = document.createElement("input"),
                    t.type = "button", t.value = c.label, t.period = c.period, t.count = c.count, t.periodObj = c, t.className = "amChartsButton " + d + "-period-input", k && e.applyStyles(t.style, k.PeriodButton), f && (t.style.width = b.width - 1 + "px"), t.style.boxSizing = "border-box", g.appendChild(t), b.addEventListeners(t), c.button = t;
        ...
        inherits: e.AmSerialChart, construct: function (a) {
            ...
            if (!this.wheelBusy && c) {
                ...
                if (c = c.chartScrollbar) {
                    var e = c.categoryAxis.minDuration(), f = this.categoryAxis.minDuration(), l = 1;
                    e >= f && (l = 4);
                    e = Math.max(e, f);
                    0 > a ? (d = c.startTime + d * e * l, e = c.endTime + 1 * e * l) : (d = c.startTime - d * e * l, e = c.endTime - 1 * e * l);
