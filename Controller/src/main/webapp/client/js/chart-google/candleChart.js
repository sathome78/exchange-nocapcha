function ChartCandleClass() {
    var that = this;
    var canvas = document.getElementById('graphic-canvas');
    var ctx;
    var candleChartAreaHeight = 130;
    var barChartAreaHeight = 60;
    ...
    canvas.height = candleChartAreaHeight+barChartAreaHeight;
    ...
    function prepareBarOptions() {
        return {
            ...
            colors: ['#525F74'],
            tooltip: {isHtml: true},
            series: {0: {type: "bars", targetAxisIndex: 0, color: "#6F819D"}},
            legend: "none"
        };
    }
