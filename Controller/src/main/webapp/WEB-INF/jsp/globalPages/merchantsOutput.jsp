...
<head>
    ...
    <script type="text/javascript" src="<c:url value="/client/js/valueInputControl.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/client/js/withdrawCreation.js"/>"></script>
