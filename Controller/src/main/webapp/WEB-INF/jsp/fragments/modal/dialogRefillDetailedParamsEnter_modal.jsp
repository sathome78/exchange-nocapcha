...
<div class="modal fade merchant-output" id="dialog-invoice-detailed-params-enter">
        ...
        <div class="input-block-wrapper clearfix">
          <div id="credits-operation-info" class="well col-md-6 col-md-offset-3 ">
            ...
            <table class="table">
              ...
              <tr>
                <td><loc:message code="invoice.bankCode"/></td>
                <td>
                  <div id="bankCode"></div>
                </td>
              </tr>
              ...
              <select id="bankId"
                ...
                <c:forEach items="${invoiceBanks}" var="bank">
                  <option value="${bank.id}"
                          ...
                          data-bank-account="${bank.accountNumber}"
                          data-bank-recipient="${bank.recipient}">
                      ${bank.name}
                  </option>
                </c:forEach>
              </select>
