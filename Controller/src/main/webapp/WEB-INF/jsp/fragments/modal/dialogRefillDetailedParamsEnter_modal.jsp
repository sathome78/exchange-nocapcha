  ...
  function checkField($elem) {
    ...
    if ($elem.closest(".input-block-wrapper").css("display") == 'none') {
      ...
      if (bankId != 0) {
        ...
        result = validateString($elem, BANK_CODE_REGEX, null, false, "fail-enter");
      }
    }
    return result;
  }

  function validateString($elem, regex, errorDiv, allowAbsent, errorClass) {
        ...
        <div id="credits-operation-info"
          ...
          <div class="row">
            <div class="credits-operation-info__item clearfix">
              <div class="col-md-3"><loc:message code="transaction.amount"/></div>
            ...
            <div class="credits-operation-info__item clearfix">
              <div class="col-md-3"><loc:message code="dashboard.amountwithcommission"/></div>
              <div class="col-md-9"><span id="total-amount"></span> <span class="currency"></span></div>
            </div>
            <div class="credits-operation-info__item clearfix">
              <div class="col-md-3"><loc:message code="merchants.invoiceDetails.bankName"/></div>
              <div class="col-md-9" id="bank-name"></div>
            </div>
            <div class="credits-operation-info__item clearfix">
              <div class="col-md-3"><loc:message code="merchants.invoiceDetails.bankAccount"/></div>
              <div class="col-md-9" id="bank-account"></div>
            </div>
            <div class="credits-operation-info__item clearfix">
              <div class="col-md-3"><loc:message code="merchants.invoiceDetails.bankRecipient"/></div>
              <div class="col-md-9" id="bank-recipient"></div>
            </div>
          </div>
        </div>
