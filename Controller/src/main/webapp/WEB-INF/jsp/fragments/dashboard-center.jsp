                ...
                <form:form id="dashboard-buy-form" class="dashboard-sell-buy__form" action="/order/submitnew/BUY"
                    ...
                    <div class="row">
                        <sec:authorize access="isAuthenticated()">
                            ...
                            <button id="dashboard-buy-accept" class="dashboard-sell-buy__button dashboard-accept__button hidden">
                ...
                <form:form id="dashboard-sell-form" class="dashboard-sell-buy__form" action="/order/submitnew/SELL"
                    ...
                    <div class="row">
                        <sec:authorize access="isAuthenticated()">
                            ...
                            <button id="dashboard-sell-accept" class="dashboard-sell-buy__button dashboard-accept__button hidden">
                                <loc:message code="orders.accept"/>
                            </button>
                        </sec:authorize>
                    </div>
