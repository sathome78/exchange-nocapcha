            ...
            <div class="col-md-8 ">
              <select class="form-control input-block-wrapper__input" id="bankSelect" <c:out value="${ disabled }"/>>
                ...
                <c:forEach items="${banks}" var="bank">
                  <option <c:out value="${bank.name.equals(invoiceRequest.payerBankName) ? selected : ''}"/>
          ...
          <div class="input-block-wrapper clearfix">
            ...
            <div class="col-md-8 ">
              <input class="form-control input-block-wrapper__input" type="text" id="bankCode" name="payerBankCode"
                     value="${invoiceRequest.payerBankCode}" <c:out value="${readonlyIfConfirmed}"/>>
            </div>
          ...
          <c:choose>
            <c:when test="${needToConfirm}">
              <c:choose>
                ...
                <c:otherwise>
                  <div class="col-md-4 input-block-wrapper">
                    <button id="invoiceSubmit" class="btn btn-primary btn-lg" type="button"><loc:message
