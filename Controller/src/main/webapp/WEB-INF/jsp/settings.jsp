                                ...
                                <fieldset class="field-user">
                                    ...
                                    <div class="form-group user-confirmpassword-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <form:password path="confirmPassword" class="form-control" id="user-confirmpassword"/>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <fieldset class="field-userFin">
                                    ...
                                    <div class="form-group userFin-confirmpassword-group">
                                        ...
                                        <div class="col-md-8">
                                            <form:errors path="confirmPassword" style="color:red"/>
                                            <form:password path="confirmPassword" class="form-control" id="userFin-confirmpassword"/>
                                        </div>
                                    </div>
