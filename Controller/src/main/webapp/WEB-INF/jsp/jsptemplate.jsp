				...
				<!-- begin chart__section -->
					<div class="chart__section">
						<div class="diagramm__box">
							<img src="client/img/grafik.png" alt=""/>
						</div>
					</div>
				<!-- end chart__section -->
					...
					<div class="sell__buy">
						<ul class="nav nav-tabs col-sm-offset-3 col-sm-7">
							<li class="active col-sm-6 col-xs-6">
								<a href="<c:url value='order/sell/new' />" data-toggle="tab">
									<loc:message code="orders.createordersell"/>
								</a>
							</li>
							<li class="col-sm-6 col-xs-6">
								<a href="<c:url value='newordertobuy'/>" data-toggle="tab">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab__sell">
								...
								<form:form class="form-horizontal withdraw__money" action="order/sell/submit" method="post" modelAttribute="order">
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											...
											<form:errors path="amountSell" class="form-control"/> 
							...
							<div class="tab-pane" id="tab__buy">
								...
								<form class="form-horizontal withdraw__money" id="" action="/">
									<div class="form-group">
										<label class="col-sm-3 control-label" for="#">Покупаю</label>
										<div class="col-sm-7">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label" for="#">Сумма</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" id="#" placeholder="2 890.89765">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" for="#">Валюта</label>
										<div class="col-sm-7">
											<select name="" id="" class="select form-control">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label" for="#">Курс</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" id="#" placeholder="129">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" for="#">Итоговая сумма</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" id="#" placeholder="568 990.98991">
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-offset-3 col-sm-6">
											<button type="button" class="btn btn-primary">Создать ордер</button>
										</div>
									</div>
								</form>
								<!-- End  withdraw__money -->
