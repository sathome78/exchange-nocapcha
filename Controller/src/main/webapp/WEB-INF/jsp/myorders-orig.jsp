                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach var="myorder" items="${orderMap.sell}">
                                                <tr>
                                                    ...
                                                    <td><fmt:formatNumber type="number" maxFractionDigits="9"                                                                          value="${myorder.amountSell}"/></td>
                                                    <td> ${myorder.currencyBuyString} </td>
                                                    <td><fmt:formatNumber type="number" maxFractionDigits="9"                                                                          value="${myorder.amountBuy}"/></td>
                                                    <td><fmt:formatNumber type="number" maxFractionDigits="9"                                                                          value="${myorder.commission}"/>%                                                    </td>
                                                    <td><fmt:formatNumber type="number" maxFractionDigits="9"                                                                          value="${myorder.amountBuyWithCommission}"/></td>
                                                    <td> ${myorder.dateCreation} </td>
                                                    <td><c:if                                                            test="${myorder.status.status eq 3}">                                                            ${myorder.dateFinal}                                                        </c:if></td>
                                                    <td>                                                            ${myorder.statusString}                                                    </td>
                                                    <td>                                                        <c:if test="${(myorder.status.status eq 2)||(myorder.status.status eq 1)}">                                                            <a href="myorders/submitdelete?id=${myorder.id}"><loc:message                                                                    code="myorders.delete"/></a>                                                        </c:if>                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach var="myorder" items="${orderMap.buy}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <fmt:formatNumber type="number" maxFractionDigits="9"
                                                                          value="${myorder.amountBuyWithCommission}"/>
                                                    </td>
                                                    <td>
