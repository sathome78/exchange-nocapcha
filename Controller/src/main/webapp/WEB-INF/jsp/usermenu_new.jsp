...
<div class="side_menu col-sm-3"> <!-- Side Menu -->
    <ul>
        <li><a  class="active" href="<c:url value="/mywallets"/>"><loc:message code="usermenu.mywallets"/></a></li>
        <li><a href="<c:url value="/orders"/>"><loc:message code="usermenu.orders"/></a></li>
