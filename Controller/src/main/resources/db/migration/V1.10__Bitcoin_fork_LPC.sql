...
INSERT INTO COMPANY_WALLET_EXTERNAL(currency_id) VALUES ((SELECT id from CURRENCY WHERE name='LPC'));
...
INSERT INTO `MERCHANT_IMAGE` (`merchant_id`, `image_path`, `image_name`, `currency_id`) VALUES ((SELECT id from MERCHANT WHERE name='LPC')
, '/client/img/merchants/LPC.png', 'LPC', (SELECT id from CURRENCY WHERE name='LPC'));

INSERT INTO WALLET (user_id, currency_id) select id, (select id from CURRENCY where name='LPC') from USER;
...
INSERT INTO `COMPANY_WALLET` (`currency_id`) VALUES ((select id from CURRENCY where name = 'LPC'));
