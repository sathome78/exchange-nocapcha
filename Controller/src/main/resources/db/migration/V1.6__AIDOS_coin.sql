...
INSERT INTO COMPANY_WALLET_EXTERNAL(currency_id) VALUES ((SELECT id from CURRENCY WHERE name='ADK'));
...
INSERT INTO `MERCHANT_IMAGE` (`merchant_id`, `image_path`, `image_name`, `currency_id`) VALUES ((SELECT id from MERCHANT WHERE name='ADK')
, '/client/img/merchants/ADK.png', 'ADK', (SELECT id from CURRENCY WHERE name='ADK'));

INSERT INTO WALLET (user_id, currency_id) select id, (select id from CURRENCY where name='ADK') from USER;
...
INSERT INTO `COMPANY_WALLET` (`currency_id`) VALUES ((select id from CURRENCY where name = 'ADK'));
