    ...
    * */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/merchants/bitcoin/payment/accept", "/merchants/invoice/payment/accept", "/2a8fy7b07dxe44/updateTransactionAmount").hasAuthority(AdminAuthority.PROCESS_INVOICE.name())
                ...
                .antMatchers("/2a8fy7b07dxe44/editCurrencyLimits/submit",
                        "/2a8fy7b07dxe44/editCmnRefRoot", "/2a8fy7b07dxe44/editLevel", "/2a8fy7b07dxe44/commissions/editCommission", "/2a8fy7b07dxe44/commissions/editMerchantCommission",
                        "/2a8fy7b07dxe44/merchantAccess/toggleBlock", "/2a8fy7b07dxe44/merchantAccess/setBlockForAll").hasAuthority(AdminAuthority.SET_CURRENCY_LIMIT.name())
                ...
                .antMatchers(HttpMethod.POST, "/2a8fy7b07dxe44/bitcoinWallet/**").hasAuthority(AdminAuthority.MANAGE_BTC_CORE_WALLET.name())
                ...
                .antMatchers(HttpMethod.POST, "/merchants/edc/payment/received").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/rest/userFiles/**/receipts/**").permitAll()
                .antMatchers(HttpMethod.GET, "/rest/stockExchangeStatistics", "/rest/temp/retrieveCurrencyPairRates").permitAll()
