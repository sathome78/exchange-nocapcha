 ...
 */
public class SPD extends Contract implements ethTokenERC20 {
    ...
    public RemoteCall<List> lockUpAmountOf(String _holder) {
        final Function function = new Function("lockUpAmountOf", 
    ...
    public RemoteCall<Tuple7<String, String, String, String, String, String, String>> lockUpAmountStrOf(String _address) {
        final Function function = new Function("lockUpAmountStrOf", 
