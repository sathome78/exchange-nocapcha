...
public interface CoreWalletService {
  void initCoreClient(String nodePropertySource, String passPropertySource, boolean supportInstantSend, boolean supportSubtractFee, boolean supportReferenceLine);
