 ...
 */
public final class REP extends Contract implements ethTokenERC20 {
    ...
    private REP(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    private REP(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public Future<Bool> initialized() {
        Function function = new Function("initialized", 
                Arrays.<Type>asList(), 
    ...
    public Future<TransactionReceipt> migrateBalance(Address _holder) {
        Function function = new Function("migrateBalance", Arrays.<Type>asList(_holder), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Uint256> targetSupply() {
        Function function = new Function("targetSupply", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public Future<TransactionReceipt> migrateBalances(DynamicArray<Address> _holders) {
        Function function = new Function("migrateBalances", Arrays.<Type>asList(_holders), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }
    ...
    public Future<Address> legacyRepContract() {
        Function function = new Function("legacyRepContract", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public static Future<REP> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Address _legacyRepContract, Uint256 _amountUsedToFreeze, Address _accountToSendFrozenRepTo) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_legacyRepContract, _amountUsedToFreeze, _accountToSendFrozenRepTo));
        return deployAsync(REP.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }

    public static Future<REP> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Address _legacyRepContract, Uint256 _amountUsedToFreeze, Address _accountToSendFrozenRepTo) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_legacyRepContract, _amountUsedToFreeze, _accountToSendFrozenRepTo));
        return deployAsync(REP.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }
