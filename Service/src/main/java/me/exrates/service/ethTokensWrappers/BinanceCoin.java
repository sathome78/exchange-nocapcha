 ...
 */
public final class BinanceCoin extends Contract implements ethTokenERC20 {
    ...
    private BinanceCoin(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    private BinanceCoin(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public Future<TransactionReceipt> withdrawEther(Uint256 amount) {
        Function function = new Function("withdrawEther", Arrays.<Type>asList(amount), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }
    ...
    public Future<TransactionReceipt> unfreeze(Uint256 _value) {
        Function function = new Function("unfreeze", Arrays.<Type>asList(_value), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }
    ...
    public Future<Uint256> freezeOf(Address param0) {
    ...
    public Future<TransactionReceipt> freeze(Uint256 _value) {
    ...
    public static Future<BinanceCoin> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Uint256 initialSupply, Utf8String tokenName, Uint8 decimalUnits, Utf8String tokenSymbol) {
        ...
        return deployAsync(BinanceCoin.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }

    public static Future<BinanceCoin> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Uint256 initialSupply, Utf8String tokenName, Uint8 decimalUnits, Utf8String tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(initialSupply, tokenName, decimalUnits, tokenSymbol));
        return deployAsync(BinanceCoin.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }
