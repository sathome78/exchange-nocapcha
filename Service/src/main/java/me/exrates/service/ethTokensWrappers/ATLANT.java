 ...
 */
public final class ATLANT extends Contract implements ethTokenERC20 {
    ...
    private ATLANT(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    private ATLANT(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public Future<TransactionReceipt> mint(Address _holder, Uint256 _value) {
        Function function = new Function("mint", Arrays.<Type>asList(_holder, _value), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Address> ico() {
    ...
    public Future<TransactionReceipt> unfreeze() {
        Function function = new Function("unfreeze", Arrays.<Type>asList(), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }
    ...
    public Future<Bool> tokensAreFrozen() {
        Function function = new Function("tokensAreFrozen", 
                Arrays.<Type>asList(), 
    ...
    public static Future<ATLANT> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Address _ico) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_ico));
        return deployAsync(ATLANT.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }

    public static Future<ATLANT> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Address _ico) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_ico));
        return deployAsync(ATLANT.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }
