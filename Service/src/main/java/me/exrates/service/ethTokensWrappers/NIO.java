 ...
 */
public final class NIO extends Contract implements ethTokenERC20{
    ...
    private NIO(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    private NIO(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public Future<Bool> canMintBurn() {
        Function function = new Function("canMintBurn", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<TransactionReceipt> transferFrom(Address _from, Address _to, Uint256 _amount, BigInteger weiValue) {
    ...
    public Future<Uint256> numberOfAddress() {
        Function function = new Function("numberOfAddress", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<TransactionReceipt> getHour(Uint256 timestamp) {
        Function function = new Function("getHour", Arrays.<Type>asList(timestamp), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }
    ...
    public Future<TransactionReceipt> getWeekday(Uint256 timestamp) {
        Function function = new Function("getWeekday", Arrays.<Type>asList(timestamp), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<TransactionReceipt> changeHoldingTaxInterval(Uint256 _newValue) {
        Function function = new Function("changeHoldingTaxInterval", Arrays.<Type>asList(_newValue), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Uint256> lastHoldingTax() {
        Function function = new Function("lastHoldingTax", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<Utf8String> physicalString() {
        Function function = new Function("physicalString", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public Future<Uint256> txnTax() {
        Function function = new Function("txnTax", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<Bool> isSecured() {
        Function function = new Function("isSecured", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<TransactionReceipt> getSecond(Uint256 timestamp) {
        Function function = new Function("getSecond", Arrays.<Type>asList(timestamp), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }
    ...
    public Future<Uint256> addressIndex(Address param0) {
        Function function = new Function("addressIndex", 
                Arrays.<Type>asList(param0), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public Future<TransactionReceipt> mint(Uint256 _value) {
        Function function = new Function("mint", Arrays.<Type>asList(_value), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Bool> addressExists(Address param0) {
        Function function = new Function("addressExists", 
                Arrays.<Type>asList(param0), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<TransactionReceipt> chargeHoldingTax() {
        Function function = new Function("chargeHoldingTax", Arrays.<Type>asList(), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<TransactionReceipt> transfer(Address _to, Uint256 _value, BigInteger weiValue) {
    ...
    public Future<TransactionReceipt> addAddressManual(Address addr) {
        Function function = new Function("addAddressManual", Arrays.<Type>asList(addr), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Uint256> holdingTaxInterval() {
        Function function = new Function("holdingTaxInterval", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<Utf8String> cryptoString() {
        Function function = new Function("cryptoString", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<TransactionReceipt> removeAddressManual(Address addr) {
        Function function = new Function("removeAddressManual", Arrays.<Type>asList(addr), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<TransactionReceipt> changeHoldingTax(Uint256 _newValue) {
        Function function = new Function("changeHoldingTax", Arrays.<Type>asList(_newValue), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Uint256> holdingTaxDecimals() {
        Function function = new Function("holdingTaxDecimals", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public Future<Uint256> holdingTax() {
        Function function = new Function("holdingTax", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<TransactionReceipt> changeTxnTax(Uint256 _newValue) {
        Function function = new Function("changeTxnTax", Arrays.<Type>asList(_newValue), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Address> addresses(Uint256 param0) {
    ...
    public Future<TransactionReceipt> getMinute(Uint256 timestamp) {
        Function function = new Function("getMinute", Arrays.<Type>asList(timestamp), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Bool> isPrivate() {
        Function function = new Function("isPrivate", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public static Future<NIO> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Utf8String n, Utf8String a, Uint256 totalSupplyToUse, Bool isSecured, Bool cMB, Utf8String physical, Utf8String crypto, Uint256 txnTaxToUse, Uint256 holdingTaxToUse, Uint256 holdingTaxIntervalToUse, Bool isPrivateToUse) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(n, a, totalSupplyToUse, isSecured, cMB, physical, crypto, txnTaxToUse, holdingTaxToUse, holdingTaxIntervalToUse, isPrivateToUse));
        return deployAsync(NIO.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }

    public static Future<NIO> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Utf8String n, Utf8String a, Uint256 totalSupplyToUse, Bool isSecured, Bool cMB, Utf8String physical, Utf8String crypto, Uint256 txnTaxToUse, Uint256 holdingTaxToUse, Uint256 holdingTaxIntervalToUse, Bool isPrivateToUse) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(n, a, totalSupplyToUse, isSecured, cMB, physical, crypto, txnTaxToUse, holdingTaxToUse, holdingTaxIntervalToUse, isPrivateToUse));
        return deployAsync(NIO.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }
