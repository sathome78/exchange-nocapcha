 ...
 */
public final class Golem extends Contract implements ethTokenNotERC20 {
    ...
    private Golem(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    private Golem(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public Future<Address> golemFactory() {
        Function function = new Function("golemFactory", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public Future<TransactionReceipt> setMigrationMaster(Address _master) {
        Function function = new Function("setMigrationMaster", Arrays.<Type>asList(_master), Collections.<TypeReference<?>>emptyList());
    ...
    public Future<TransactionReceipt> migrate(Uint256 _value) {
        Function function = new Function("migrate", Arrays.<Type>asList(_value), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

//    public Future<TransactionReceipt> finalize() {
//        Function function = new Function("finalize", Arrays.<Type>asList(), Collections.<TypeReference<?>>emptyList());
//        return executeTransactionAsync(function);
//    }

    public Future<TransactionReceipt> refund() {
        Function function = new Function("refund", Arrays.<Type>asList(), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Address> migrationMaster() {
        Function function = new Function("migrationMaster", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<Uint256> tokenCreationCap() {
    ...
    public Future<TransactionReceipt> setMigrationAgent(Address _agent) {
        Function function = new Function("setMigrationAgent", Arrays.<Type>asList(_agent), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }

    public Future<Address> migrationAgent() {
        Function function = new Function("migrationAgent", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<Uint256> fundingEndBlock() {
    ...
    public Future<Uint256> totalMigrated() {
        Function function = new Function("totalMigrated", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public Future<Uint256> tokenCreationMin() {
    ...
    public Future<Bool> funding() {
        Function function = new Function("funding", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<Uint256> tokenCreationRate() {
        Function function = new Function("tokenCreationRate", 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public Future<Uint256> fundingStartBlock() {
    ...
    public static Future<Golem> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Address _golemFactory, Address _migrationMaster, Uint256 _fundingStartBlock, Uint256 _fundingEndBlock) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_golemFactory, _migrationMaster, _fundingStartBlock, _fundingEndBlock));
        return deployAsync(Golem.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }

    public static Future<Golem> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Address _golemFactory, Address _migrationMaster, Uint256 _fundingStartBlock, Uint256 _fundingEndBlock) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_golemFactory, _migrationMaster, _fundingStartBlock, _fundingEndBlock));
        return deployAsync(Golem.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor, initialWeiValue);
    }
