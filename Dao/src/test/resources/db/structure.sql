...
CREATE TABLE `WITHDRAW_REQUEST` (
  ...
  merchant_commission_currency int(40) DEFAULT null,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT fk_withdraw_request_merchant_commission_currency FOREIGN KEY (merchant_commission_currency) REFERENCES CURRENCY(id),
