...
CREATE TABLE DATABASE_PATCH (version VARCHAR(50), date TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
LOCK TABLES DATABASE_PATCH WRITE;
INSERT INTO DATABASE_PATCH (version) VALUES ("patch_07_modified_transaction_table");
UNLOCK TABLES;
