...
ALTER TABLE INVOICE_REQUEST ADD payee_bank_name VARCHAR(200) NULL;
ALTER TABLE INVOICE_REQUEST ADD payee_account VARCHAR(100) NULL;
...
ALTER TABLE INVOICE_REQUEST MODIFY payee_bank_name VARCHAR(200) CHARACTER SET utf8;
ALTER TABLE INVOICE_REQUEST MODIFY payee_account VARCHAR(100) CHARACTER SET utf8;
