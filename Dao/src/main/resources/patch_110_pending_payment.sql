ALTER TABLE WITHDRAW_REQUEST
	ADD COLUMN amount DECIMAL(40,9) NULL DEFAULT NULL,
	ADD COLUMN commission DECIMAL(40,9) NULL DEFAULT NULL,
...
ALTER TABLE WITHDRAW_REQUEST
	...
	ADD COLUMN status_modification_date TIMESTAMP NULL DEFAULT NULL;
