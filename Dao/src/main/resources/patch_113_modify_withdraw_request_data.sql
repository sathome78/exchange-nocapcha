...
(user_wallet_id, company_wallet_id, amount, commission_amount, commission_id, operation_type_id, currency_id, merchant_id, datetime, provided, confirmation, order_id, status_id, status_modification_date, active_balance_before, reserved_balance_before, company_balance_before, company_commission_balance_before, source_type, source_id, provided_modification_date) 
(SELECT W.id, CW.id, -WR.amount, 0, COM.id, 5, WR.currency_id, WR.merchant_id, WR.date_creation, 1, -1, NULL, 1, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, 'WITHDRAW', WR.id, NULL
...
еще удалить транзакции, который связаны с созданием операции