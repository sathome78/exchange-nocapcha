...
VALUES((select id from CURRENCY where name = 'DOGE'), (select id from CURRENCY where name = 'USD'), 'DOGE/USD', 281, 0);
...
VALUES((select id from CURRENCY where name = 'DOGE'), (select id from CURRENCY where name = 'BTC'), 'DOGE/BTC', 282, 0, 'BTC');
