...
(
  ...
  KEY `2FA_NOTIFICATION_MESSAGES_type` (`type`),
  KEY `2FA_NOTIFICATION_MESSAGES_event` (`event`),
  CONSTRAINT `fk_2FA_NOTIFICATION_MESSAGES_type` FOREIGN KEY (`type`) REFERENCES `2FA_NOTIFICATOR` (`name`),
  CONSTRAINT `fk_2FA_NOTIFICATION_MESSAGES_event` FOREIGN KEY (`event`) REFERENCES `2FA_USER_NOTIFICATION_MESSAGE_SETTINGS` (`event_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(
  ...
  CONSTRAINT `fk_2FA_NOTIFICATION_PRICE_role_id` FOREIGN KEY (`role_id`) REFERENCES `USER` (`roleid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
