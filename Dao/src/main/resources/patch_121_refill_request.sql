...
ALTER TABLE TRANSACTION
	CHANGE COLUMN source_type source_type ENUM('ORDER','MERCHANT','REFERRAL','ACCRUAL','MANUAL','USER_TRANSFER','INVOICE','BTC_INVOICE','WITHDRAW','STOP_ORDER','REFILL') NULL DEFAULT NULL;
