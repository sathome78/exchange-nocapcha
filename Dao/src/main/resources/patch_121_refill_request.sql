...
DELETE FROM REFILL_REQUEST_STATUS;
...
UPDATE TRANSACTION
	SET status_modification_date = datetime
	WHERE  CAST(status_modification_date AS CHAR(20)) = '0000-00-00 00:00:00';

ALTER TABLE TRANSACTION
	CHANGE COLUMN source_type source_type ENUM('ORDER','MERCHANT','REFERRAL','ACCRUAL','MANUAL','USER_TRANSFER','INVOICE','BTC_INVOICE','WITHDRAW','REFILL', 'STOP_ORDER') NULL DEFAULT NULL;
