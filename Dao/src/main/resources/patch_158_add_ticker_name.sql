...
ADD COLUMN `ticker_name` VARCHAR(45) NOT NULL AFTER `market`;
UPDATE CURRENCY_PAIR set CURRENCY_PAIR.ticker_name = CURRENCY_PAIR.name;
...
UPDATE CURRENCY_PAIR SET `ticker_name`='MIOTA/USD' WHERE CURRENCY_PAIR.name = 'IOTA/USD';
UPDATE CURRENCY_PAIR SET `ticker_name`='MIOTA/BTC' WHERE CURRENCY_PAIR.name ='IOTA/BTC';
