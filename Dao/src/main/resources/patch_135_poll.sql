...
INSERT INTO `survey_item` VALUES (2, 1, 'ru', 'question2', 'Не удобный ввод/вывод монет и валют');
INSERT INTO `survey_item` VALUES (3, 1, 'ru', 'question3', 'Высокие комиссии торгов и ввода/вывода');
INSERT INTO `survey_item` VALUES (9, 1, 'ru', 'question4', 'Не удобный интерфейс для провдения торгов');
...
INSERT INTO `survey_lang_param` VALUES (1, 1, 'ru', 'С целью улучшения качества работы Биржи просим Вас ответить на несколько вопросов.\r\n<br>Это займет у вас всего пару минут\r\n</br>Пожалуйста, оцените их, поставив оценки для нескольких утверждений по принципу:\r\n</br>"1" - для меня это не проблема\r\n</br>"5" - это, то, что меня заставит покинуть Биржу');
INSERT INTO `survey_lang_param` VALUES (2, 1, 'en', 'In order to improve the quality of the work of the Exchange, we ask you to answer a few questions.\r\n</br>It only takes you a couple of minutes\r\n</br>Please rate them by putting estimates for several statements on the principle:\r\n</br>"1" - for me this is not a problem\r\n</br>"5" - is what will force me to leave the Exchange');
